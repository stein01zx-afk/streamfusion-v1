...
function currentViewSettingsKey(){
    ...
    function fontFamily(font){ const map = { inter:'Inter, Manrope, sans-serif', poppins:'Poppins, sans-serif', montserrat:'Montserrat, sans-serif', oswald:'Oswald, sans-serif', system:'system-ui, sans-serif', mono:'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', serif:'Georgia, \"Times New Roman\", serif', emoji:'\"Segoe UI Emoji\", \"Apple Color Emoji\", \"Noto Color Emoji\", Segoe UI, Arial, sans-serif' }; return map[String(font || 'inter')] || map.inter; }
