...
async function primeAvatar(platform, username, onResolved) {
...
function setAvatarImage(img, platform, username) {
  const seed = normalizeUsername(username || platform || "user") || platform;
  img.src = fallbackAvatar(seed, platform);
