...
export const VOICE_RULE_SPECS = [
  ...
  { voiceKey: "missa_death_note", voiceLabel: "Missa Death Note", aliases: ["missadeathnote", "missa death note", "death", "note", "missa"] },
  ...
  { voiceKey: "nagi_seishiro", voiceLabel: "Nagi Seishiro", aliases: ["nagi", "nagi seishiro", "nagi seishirou", "nagi seishiroo", "nagy seishiro", "seishiro"] },
  { voiceKey: "eren_yeager", voiceLabel: "Eren Yeager", aliases: ["eren", "eren yeager", "eren jeager", "eren jaeger", "shingeki eren", "attack on titan eren"] },
  { voiceKey: "thanos", voiceLabel: "Thanos", aliases: ["thanos", "thanoss", "thannos", "mad titan", "titan loco"] },
  { voiceKey: "mikasa", voiceLabel: "Mikasa", aliases: ["mikasa", "mikasa ackerman", "mikasa akerman", "mikasaa", "ackerman mikasa"] },
  { voiceKey: "inosuke_ds", voiceLabel: "Inosuke DS", aliases: ["inosuke", "inosuke ds", "inosuke demon slayer", "inosuke kimetsu", "inosuke slayer"] },
  { voiceKey: "tom_spiderman", voiceLabel: "Tom Spiderman", aliases: ["tom spiderman", "tom holland", "tom holland spiderman", "spiderman tom", "spider man tom"] },
  { voiceKey: "meliodas", voiceLabel: "Meliodas", aliases: ["meliodas", "meliodas", "melio", "seven deadly sins meliodas", "nanatsu meliodas"] },
  { voiceKey: "escanor", voiceLabel: "Escanor", aliases: ["escanor", "escanorrr", "escanor the one", "seven deadly sins escanor", "the one"] },
  { voiceKey: "zenitsu_ds", voiceLabel: "Zenitsu DS", aliases: ["zenitsu", "zenitsu ds", "zenitsu demon slayer", "zenitsu kimetsu", "zenitsu slayer"] },
  { voiceKey: "mitsuri_ds", voiceLabel: "Mitsuri DS", aliases: ["mitsuri", "mitsuri ds", "mitsuri demon slayer", "mitsuri kimetsu", "mitsuri slayer"] },
  { voiceKey: "giyuu_tomioka_ds", voiceLabel: "Giyuu Tomioka DS", aliases: ["giyuu", "giyu", "giyuu tomioka ds", "giyu tomioka", "tomioka", "giyuu ds"] },
  { voiceKey: "sanemi_ds", voiceLabel: "Sanemi DS", aliases: ["sanemi", "sanemi ds", "sanemi shinazugawa", "shinazugawa", "sanemi demon slayer"] },
  { voiceKey: "muichiro_tokito", voiceLabel: "Muichiro Tokito", aliases: ["muichiro", "muichiro tokito", "tokito", "muichirou", "muichiro tokitō"] },
  { voiceKey: "kyojuro_rengoku", voiceLabel: "Kyojuro Rengoku", aliases: ["rengoku", "kyojuro", "kyojuro rengoku", "kyoujuro", "rengoku kyojuro"] },
];
