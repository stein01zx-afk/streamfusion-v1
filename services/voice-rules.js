...
export const VOICE_RULE_SPECS = [
  ...
  { voiceKey: "nagi_seishiro", voiceLabel: "Nagi Seishiro", aliases: ["nagi", "nagi seishiro", "nagiseishiro", "nagi seishi", "seishiro"] },
  { voiceKey: "eren_yeager", voiceLabel: "Eren Yeager", aliases: ["eren", "eren yeager", "eren jaeger", "erenyeager", "erenjaeger"] },
  { voiceKey: "thanos", voiceLabel: "Thanos", aliases: ["thanos", "thanos voz", "thanos voice"] },
  { voiceKey: "mikasa", voiceLabel: "Mikasa", aliases: ["mikasa", "mikasa ackerman", "mikasaackerman"] },
  { voiceKey: "inosuke_ds", voiceLabel: "Inosuke DS", aliases: ["inosuke", "inosuke ds", "inosukeds", "inosuke demon slayer"] },
  { voiceKey: "tom_spiderman", voiceLabel: "Tom Spiderman", aliases: ["tom spiderman", "tomspiderman", "spiderman", "spider man"] },
  { voiceKey: "meliodas", voiceLabel: "Meliodas", aliases: ["meliodas", "meliodas voz", "meliodas voice", "melliodas"] },
  { voiceKey: "escanor", voiceLabel: "Escanor", aliases: ["escanor", "eskanor", "escanor voz"] },
  { voiceKey: "zenitsu_ds", voiceLabel: "Zenitsu DS", aliases: ["zenitsu", "zenitsu ds", "zenitsuds", "zenitsu demon slayer"] },
  { voiceKey: "mitsuri_ds", voiceLabel: "Mitsuri DS", aliases: ["mitsuri", "mitsuri ds", "mitsurids", "mitsuri kanroji"] },
  { voiceKey: "giyuu_tomioka_ds", voiceLabel: "Giyuu Tomioka DS", aliases: ["giyuu", "giyuu tomioka", "giyu tomioka", "tomioka", "giyuutomioka"] },
  { voiceKey: "sanemi_ds", voiceLabel: "Sanemi DS", aliases: ["sanemi", "sanemi ds", "sanemids"] },
  { voiceKey: "muichiro_tokito", voiceLabel: "Muichiro Tokito", aliases: ["muichiro", "muichiro tokito", "tokito", "muichirotokito"] },
  { voiceKey: "kyojuro_rengoku", voiceLabel: "Kyojuro Rengoku", aliases: ["kyojuro", "kyojuro rengoku", "kyojurorengoku", "rengoku", "kyoujuro"] },
